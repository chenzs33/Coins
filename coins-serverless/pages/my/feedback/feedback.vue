<template>
	<view>
		...
		<view class="bottom-btn flex-center" @click="addFeedback"><view class="btn">提交</view></view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		addFeedback() {
			...
			this.reqFeedback('addFeedback', formdata).then(res => {
				uni.showToast({
					icon: 'none',
					position: 'bottom',
					title: '感谢您的意见'
